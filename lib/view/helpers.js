...
module.exports = function(){
  return {
    ...
    __ : function() {
      ...
      if (options && options.data && options.data.root && typeof options.data.root.__ === 'function') {
        return options.data.root.__.apply(this, args);
      }
    ...
    __n : function() {
      var args = Array.prototype.slice.call(arguments);
      var options = args.pop();
      if (options && options.data && options.data.root && typeof options.data.root.__n === 'function') {
        return options.data.root.__n.apply(this, args);
      }
