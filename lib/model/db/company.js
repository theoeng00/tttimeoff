...
module.exports = function(sequelize, DataTypes) {
  var Company = sequelize.define("Company", {
    ...
    attendance_enabled: {type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false},
    attendance_verification_mode: {type: DataTypes.STRING, allowNull: false, defaultValue: 'gps'},
    attendance_network_cidr: {type: DataTypes.STRING, allowNull: false, defaultValue: '192.168.1.0/24'},
    attendance_location_name: {type: DataTypes.STRING, allowNull: true},
    attendance_latitude: {type: DataTypes.DECIMAL(10, 7), allowNull: true},
    attendance_longitude: {type: DataTypes.DECIMAL(10, 7), allowNull: true},
    attendance_radius_m: {type: DataTypes.INTEGER, allowNull: false, defaultValue: 150},
    attendance_start_time: {type: DataTypes.STRING, allowNull: false, defaultValue: '08:30'},
    attendance_end_time: {type: DataTypes.STRING, allowNull: false, defaultValue: '17:30'},
    attendance_grace_minutes: {type: DataTypes.INTEGER, allowNull: false, defaultValue: 10},
    attendance_ot_after_minutes: {type: DataTypes.INTEGER, allowNull: false, defaultValue: 30},
  }, {
    ...
    classMethods: {
      ...
      associate : models => {
        ...
        Company.hasMany(models.Attendance, {as: 'attendance_records', foreignKey: 'company_id'});
      },
