...
LeaveDay.prototype.is_two_hours_leave = function(){
  return String(this.day_part) === String(this.sequelize.models.Leave.leave_day_part_two_hours());
};

LeaveDay.prototype.get_deducted_days_number = function(){
  if (this.is_two_hours_leave()) return 0.25;
  if (this.is_all_day_leave()) return 1;
  return 0.5;
};
